...
**Prérequis** : Un ordinateur, un navigateur et une connexion Internet sont nécessaires.
...
**Exemple :** une application Web permet de créer un document, envoyer un message ou gérer une commande.
